    ...
    <div class="t-container-navbar">
        ...
        <div class="t-container-tow">
            ...
            <nav class="t-container-content" >
                <router-link tag="div" class="t-container-list" to="/home">权限列表</router-link>
                <router-link tag="div" class="t-container-list" to="/about">新增列表</router-link>
                <router-link tag="div" class="t-container-list" to="/test">用户列表</router-link>
...
<script lang="ts">
import { manageSysRoleMenuUserId } from '@/request/nabarInteface';
